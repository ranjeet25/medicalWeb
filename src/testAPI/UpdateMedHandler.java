...
public class UpdateMedHandler implements HttpHandler {
	...
	public void handle(HttpExchange exchange) throws IOException {
        ...
        String fieldNumstr = queryParams.get("fieldNum");
        String newValue = queryParams.get("newValue");
        ...
        try {
            ...
            fieldNum = Integer.parseInt(fieldNumstr);
        ...
        try {
        	med.updateMedicineDetails(medID, fieldNum, newValue);
            String jsonResponse = "{\"message\": \"Data Updated and saved in DB successfully!\"}";
            //System.out.println("Data Updated in DB successfully");
            sendResponse(exchange, jsonResponse);
        } catch (Exception e) {
            e.printStackTrace();
            String errorResponse = "{\"error\": \"Failed to update data in DB.\"}";
